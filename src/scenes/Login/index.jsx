...
const Login = () => {
    ...
    return (
        <div className='bg-body-400 grid justify-center items-center h-screen w-screen font-main'>
            <div className='bg-body-300 w-2/3 max-w-5/6 sm:max-w-l md:max-w-5/6 h-auto shadow-md rounded-lg mx-auto'>
                ...
                <div className='flex flex-col sm:flex-row justify-around items-center px-6'>
                    ...
                    {/* left side */}
                    <img src="src/assets/jason-briscoe-UV81E0oXXWQ-unsplash.jpg" style={{ objectFit: 'cover', objectPosition: 'center' }} className='w-full sm:w-[50%] md:w-[40%] mx-6 my-4 rounded-lg' />

                    {/* right side */}
                    <div className='mx-6 my-4 w-[100%] md:w-[45%]'>
                        <h2 className='font-bold text-cblue-500'>Login</h2>

                        <div className='flex my-5 border border-cblue-500 text-cblue-500 fill-cblue-500 rounded-lg py-3 px-6 gap-8 w-[100%] hover:bg-cblue-500 hover:cursor-pointer hover:fill-body-300 hover:text-body-300'>
                        ...
                        <div className='flex my-4 border border-cred-500 text-cred-500 fill-cred-500 rounded-lg py-3 px-6 gap-8 w-[100%] hover:bg-cred-500 hover:cursor-pointer hover:fill-body-300 hover:text-body-300'>
                        ...
                        <form action="/">
                            <div className='relative'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 absolute fill-body-500 top-3 left-[85%]">
                            ...
                            <div className='flex justify-between items-center'>
                                <label htmlFor="remember" className='flex items-center'>
                                    <input id='remember' name="Remember" type='checkbox' className='bg-white accent-cred-500 appearance-none h-4 w-4 cursor-pointer border border-body-400 rounded-sm' />
                                    <svg className="absolute h-4 w-4 opacity-0 check-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
