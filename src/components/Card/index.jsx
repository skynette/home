...
const Card = (props) => {
	...
	return (
		<div className="h-[58vh] w-[93%] bg-body-300 m-auto mt-14 shadow-md hover:shadow-lg transform hover:scale-[1.02] hover:transition-transform hover:duration-500 rounded-lg mb-12 flex flex-col items-center justify-center font-main">
