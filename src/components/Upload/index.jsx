      ...
      <div className='bg-body-300 p-6 pb-14 rounded-md'>
        ...
        <div className='lg:flex lg:gap-4'>
          <div className='mt-6 w-full'>
            ...
            <input id='price' type='text' className='w-full h-12 rounded-md outline-none px-4 text-body-800 border border-body-400'/>
          </div>
          <div className='mt-6 w-full'>
            <label className='block text-body-800 my-2' htmlFor='area'>Area</label>
            <input id='area' type='text' className='w-full h-12 rounded-md outline-none px-4 text-body-800 border border-body-400'/>
          </div>
          <div className='mt-6 w-full'>
            <label className='block text-body-800 my-2' htmlFor='rooms'>Rooms</label>
            <input id='rooms' type='number' className='w-full h-12 rounded-md outline-none px-4 text-body-800 border border-body-400'/>
          </div>
        </div>
      </div>
